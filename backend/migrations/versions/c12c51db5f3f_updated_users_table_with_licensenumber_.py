"""Updated users table with licenseNumber, specialization, and certificationId
...
def upgrade():
    ...
    sa.Column('certificationId', sa.String(length=50), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=False),
    sa.Column('labtech_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['labtech_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['patient_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )

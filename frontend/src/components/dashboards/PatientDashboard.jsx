// frontend/src/components/dashboards/PatientDashboard.jsx
...
const PatientDashboard = () => {
  ...
  const handleBook = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${API_URL}/patient/book`, formData, { headers });
  ...
  const fetchAppointments = async () => {
    try {
      const res = await axios.get(`${API_URL}/patient/appointments`, { headers });
  ...
  const fetchLabResults = async () => {
    try {
      const res = await axios.get(`${API_URL}/patient/lab-results`, { headers });
  ...
  const fetchPrescriptions = async () => {
    try {
      const res = await axios.get(`${API_URL}/patient/prescriptions`, { headers });
